	...
	<div class="cli-page-header">
		<div class="cli-page-header-title">
			<h1 class="title">
				...
				<span class="text">Mes forums</span>
			</h1>
		</div>
				...
				<div class="cli-page-body-sidebar">
					<div class="cli-page-body-sidebar-menu">
						<ul class="cli-page-body-sidebar-menu-list big">
							<li>
								<a href="<?=base_url().'users/forums';?>" class="">Tous les forums</a>
							</li>
							<li>
								<a href="<?=base_url().'users/mes_forums';?>" class="active">
									Mes forums
									<span class="i-num"><?=$pgt_totalResult;?></span>
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="cli-page-body-main">
					...
					<div class="cli-page-body-main-content">
						<div class="i-forum-list">
							<?php 
							if($mes_forums):
								foreach($mes_forums as $forum):
									$idFor = $forum->idFor;
									$libFor = $forum->libFor;
									$statut = $forum->statutFor;
									if($statut==0):
										$statutText ='Fermé';
										$statutClass = 'fermer';
									elseif($statut==1):
